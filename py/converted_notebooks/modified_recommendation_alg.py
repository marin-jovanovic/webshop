...
customers = pd.read_csv('../data/users_id.csv')
...
df_matrix_norm = (df_matrix - 0) / (1)

# df_matrix_norm = (df_matrix - df_matrix.min()) / (df_matrix.max() - df_matrix.min())
print("df matrix norm", df_matrix_norm.shape)
df_matrix_norm.head()
...
print("data norm", data_norm.shape)
data_norm.head()
...
# df_output = df_rec[['customerId', 'recommendedProducts']].drop_duplicates().sort_values('customerId').set_index(
#     'customerId')
#
#
...
#         'customerId')
#     if print_csv:
#         df_output.to_csv('../output/my_users.csv')
